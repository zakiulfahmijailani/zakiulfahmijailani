...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-zakiul--fahmi--jailani-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/zakiul-fahmi-jailani/)
[![Instagram](https://img.shields.io/badge/Instagram-zakiul__fahmi__jailani-E4405F?style=flat&logo=instagram&logoColor=white)](https://www.instagram.com/zakiul_fahmi_jailani/?hl=en)
...
Researcher and lecturer with a focus on **Agentic GeoAI**, **spatial data science**, and **educational technology**. My work sits at the intersection of geographic information systems, large language models, and public policy — particularly in the context of Indonesia's urban and regional development.
...
> 🎓 **MSc** in Geo-Information Science — Wageningen University & Research, The Netherlands  
...
- **Agentic AI Systems** for geospatial analysis and decision support
- **Geographic Vector Embeddings** and spatial knowledge graphs
...
> 💰 Total secured funding: **USD 25,000 + IDR 68,400,000** (~USD 29,178 equivalent)
...
| 2022–2023 | **Comparison of the Performance of the VADER and RoBERTa Algorithms on Twitter** | Lembaga Penelitian dan Pengembangan, Universitas Bakrie (Jakarta, ID) | Principal Investigator | IDR 20,000,000 |
...
|---|---|---|
| [**SIGAPP**](https://github.com/zakiulfahmijailani/SIGAPP) | Agentic GeoAI system for education planning in NTT | TypeScript, PostGIS, LLM |
| [**SIPEKA**](https://github.com/zakiulfahmijailani/SIPEKA) | Curriculum & assessment management system | TypeScript, Next.js, Supabase |
| [**IndoVilExiOW**](https://github.com/zakiulfahmijailani/IndoVilExiOW) | Village polygon extraction tool using OSM & Wikipedia | Python |
| [**PetaBencana Downloader**](https://github.com/zakiulfahmijailani/PetaBencana.id_BulkDownloader) | Bulk API downloader & GeoJSON converter for disaster data | Python |
| [**Ambulance Response Time Jakarta**](https://github.com/zakiulfahmijailani/Ambulance_Response_Time_Jakarta) | Spatial analysis of ambulance response across Jakarta | Python, Jupyter |
| [**undang-io**](https://github.com/zakiulfahmijailani/undang-io) | Digital invitation web platform | TypeScript, Next.js |
...
*"Spatial thinking is not just about maps — it is about understanding how place shapes society."*
